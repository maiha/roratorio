...
function BuildBattleResultHtmlMIG(charaData, specData, mobData, attackMethodConfArray, battleCalcResultAll) {
	...
	// アクティブスキルによる攻撃の場合
		...
		funcRenderResultTinyHtml(objGridTiny, "詠唱", funcDIG3PXSecond(battleCalcResult.castVary, 2));
		...
		funcRenderResultTinyHtml(objGridTiny, "固定", funcDIG3PXSecond(battleCalcResult.castFixed, 2));
		...
		funcRenderResultTinyHtml(objGridTiny, "ディレイ", funcDIG3PXSecond(battleCalcResult.delaySkill, 2));
		...
		funcRenderResultTinyHtml(objGridTiny, "CT", funcDIG3PXSecond(battleCalcResult.coolTime, 2));
	}
	...
	if (g_bDefinedDamageIntervals) {
		...
		funcRenderResultTinyHtml(objGridTiny, "攻撃間隔", funcDIG3PXSecond(battleCalcResult.attackInterval, 2));
	...
	//----------------
		...
		funcRenderResultTinyHtml(objGridTiny, "攻撃間隔", funcDIG3PXSecond(battleCalcResult.castVary + battleCalcResult.castFixed + battleCalcResult.attackInterval, 2));
	}
